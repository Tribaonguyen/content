...
export function buildPrompt3FB(step2: string) {
  return `NHIỆM VỤ BƯỚC 3: Humanize (Xóa bỏ sự máy móc - Thổi hồn chuyên gia).
[BÀI VIẾT BƯỚC 2]:
"""
${step2}
"""
...
3. PHỐI HỢP VỚI MEDIA (HÌNH ẢNH/VIDEO): Dựa vào Định mức Media (${spec.img} ảnh), trước khi Kêu gọi hành động (CTA), BẮT BUỘC chèn một câu chuyển tiếp tự nhiên để "điều hướng mắt" người đọc xuống hình ảnh:
   - Nếu định mức là nhiều ảnh (ví dụ 1-3, 2-5...): Viết câu kích thích người đọc lướt xem album. (VD: "👉 Lướt xem chi tiết mặt bằng và thực tế thi công qua album bên dưới...", "Khám phá chi tiết từng hạng mục qua các ảnh sau...").
